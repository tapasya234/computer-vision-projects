...
inputFilePath = os.path.join(
    os.getcwd(),
    "computer-vision-projects/applications/motion_detection/videos/motion_test.mp4",
)
...
videoWriter = cv2.VideoWriter(
    os.path.join(
        os.getcwd(),
        "computer-vision-projects/applications/motion_detection/videos/motion_detected_output.mp4",
    ),
